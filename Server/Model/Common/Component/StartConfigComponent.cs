...
namespace ETModel
{
	...
	public class StartConfigComponent: Component
	{
		...
		public List<StartConfig> CentorConfigs { get; private set; }
		...
		public void Awake(string path, int appId)
		{
			...
			this.CentorConfigs = new List<StartConfig>();
			...
			foreach (string s in ss)
			{
				...
				try
				{
					...
					if (startConfig.AppType.Is(AppType.Centor))
					{
						this.CentorConfigs.Add(startConfig);
					}
				}
				catch (Exception e)
				{
