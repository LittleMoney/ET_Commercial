...
public class UIBehaviourEditor : Editor
{
	...
	private string searchKey
	{
		...
		set
		{
			...
			{
				_searchKey = value;
				heroPrefab = uiBehaviour.Get<Object>(searchKey);
			}
		}
	}
	...
	private SerializedProperty layerType;
	private SerializedProperty showType;
	...
	private void OnEnable()
	{
		...
		uiBehaviour = (UIBehaviour)target;
		layerType = serializedObject.FindProperty("layerType");
		showType = serializedObject.FindProperty("showType");
	...
	public override void OnInspectorGUI()
	{
		...
		Undo.RecordObject(uiBehaviour, "Changed Settings");
		var dataProperty = serializedObject.FindProperty("data");
		...
		for (int i = uiBehaviour.data.Count - 1; i >= 0; i--)
		{
			GUILayout.BeginHorizontal();
