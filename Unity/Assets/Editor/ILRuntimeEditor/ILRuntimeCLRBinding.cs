...
public static class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(types, "Assets/Model/Generated/ILBinding");
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (FileStream fs = new FileStream("Assets/Res/Code/Hotfix.dll.bytes", FileMode.Open, FileAccess.Read))
        {
	        ...
	        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(domain, "Assets/Model/Generated/ILBinding");
	        AssetDatabase.Refresh();
        }
    }
}
