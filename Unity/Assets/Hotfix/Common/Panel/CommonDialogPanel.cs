...
namespace ETHotfix
{
	...
	public class CommonDialogPanel : Component,IUICycle
    {
		#region RC 
		public UI ui;
		...
		public Queue<CommonDialogMsg> msgQueue=new Queue<CommonDialogMsg>();
    ...
    public class CommonDialogPanelAwakeSystem : AwakeSystem<CommonDialogPanel>
    {
        public override void Awake(CommonDialogPanel self)
        {
			...
			self.btnYes = (self.ui.g_uiBehaviour["btnYes"] as GameObject).GetComponent<Button>().BindAnim(); 
			self.btnNo = (self.ui.g_uiBehaviour["btnNo"] as GameObject).GetComponent<Button>().BindAnim();
			#endregion
