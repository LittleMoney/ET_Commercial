...
namespace ETHotfix
{
	public sealed class EventSystem
	{
		...
		public void Run(string type, object a)
		{
			if (this.allEvents.TryGetValue(type, out List<IEvent> iEvents))
			{
				foreach (IEvent iEvent in iEvents)
				{
					try
		...
		public void Run(string type, object a, object b)
		{
			if (this.allEvents.TryGetValue(type, out List<IEvent> iEvents))
			{
				foreach (IEvent iEvent in iEvents)
		...
		public void Run(string type, object a, object b, object c)
		{
			if (this.allEvents.TryGetValue(type, out List<IEvent> iEvents))
			{
				foreach (IEvent iEvent in iEvents)
