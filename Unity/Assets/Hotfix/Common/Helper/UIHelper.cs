...
namespace ETHotfix
{
	public static partial class UIHelper
	{
		...
		public static void OpenTipDialog(string title, string message, Action callback=null)
		{
		...
		public static void OpenYesOrNoDialog(string title, string message, Action<bool> callback=null)
		{
		...
		public static void OpenOkOrCancelDialog(string title, string message, Action<bool> callback=null)
		{
