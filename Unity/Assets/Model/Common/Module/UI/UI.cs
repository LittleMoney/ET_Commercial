...
namespace ETModel
{
	...
	public static class UISystem
	{
		...
		public static void Hide(this UI self)
        {
			...
			foreach (Component subCompoennt in self.GetComponents(typeof(IUICycle)))
			{
				(subCompoennt as IUICycle).OnHide();
			}
		}
		...
		public static void Focus(this UI self)
		{
			...
			foreach (Component subCompoennt in self.GetComponents(typeof(IUICycle)))
			{
				(subCompoennt as IUICycle).OnFocus();
			}
		}
		...
		public static void Pause(this UI self)
        {
			...
			foreach (Component subCompoennt in self.GetComponents(typeof(IUICycle)))
			{
				(subCompoennt as IUICycle).OnPause();
			}
		}
