...
namespace ETModel
{
    ...
    public class Entity : ComponentWithId
    {
        ...
        [BsonIgnore]
        protected Dictionary<Type, Component> componentDict = new Dictionary<Type, Component>();
        ...
        /// <summary>
        /// 销毁，注意Enitty是先销毁自己，再销毁绑定的Component
        /// </summary>
        ...
        public virtual IEnumerable<Component> GetComponents()
        {
            return componentDict.Values;
        }
